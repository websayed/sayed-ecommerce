    ...
    <div class="col">
        <div class="card">
            <div class="card-header py-3">
                <h6 class="text-uppercase text-center font-weight-bold text-primary">This is Add category page</h6>
                <a href="{{url('categories')}}" class="float-right d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-border-all mr-2"></i> Add Category</a>
